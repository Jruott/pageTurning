...
$.extend({
    ...
    if(currentPage > 1){
        pagerHtml +=  "<li class='pager-first'><a title='第一页' href='#'>" + "«" + "</a></li>";
        pagerHtml +=  "<li class='pager-previous'><a title='上一页' href='#'>" + "‹" + "</a></li>";
    }
    ...
    if(totalPage <= 9){   //当页数不超过9时，不会有省略的页数li，页面上总是以9页为上限的
        for(var i = 1; i <= totalPage; i++){
            if(i == currentPage){
                ...
                pagerHtml += "<li class='pager-item'><a title='第"+ i + "页' href='#'>" + i + "</a></li>";
            }
        }
    ...
    if(currentPage < totalPage){ 
        pagerHtml +=  "<li class='pager-next'><a title='下一页' href='#'>" + "›" + "</a></li>";
